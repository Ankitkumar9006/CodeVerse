  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-900 px-4">
      <div className="text-center">
        ...
        <h2 className="text-xl font-semibold text-gray-700 dark:text-gray-200 mb-2">Loading <span className="text-orange-600">CodeVerse</span>...</h2>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-20">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-4">
                {[
                  { icon: <Mail className="h-5 w-5" />, text: "ankit.99sa@gmail.com" },
                  { icon: <Phone className="h-5 w-5" />, text: "+91 7673838564" },
                  { icon: <MapPin className="h-5 w-5" />, text: "Patna, India" },
                ].map((contact, index) => (
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">© 2026 CodeVerse. All rights reserved. Built with ❤️ for developers.</p>
